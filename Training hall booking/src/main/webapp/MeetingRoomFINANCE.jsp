...
<body id="Meeting-Room-Body">
       ...
       <marquee><h1>Meeting Room 3</h1></marquee>
       </div>
         <div id="Meeting-Room-Div-A">
		<img class="Meeting Room-video" src="MeetingRoom-Finance.jpg" style="width:100%; height:100%"></img>
		 </div>
		  ...
		  <table>
		         ...
		         <br></br>
		         <br></br>
		  <tr><td><label>Capacity : </label></td><td><label>11 persons</label></td></tr>
		  <tr><td><label>Screen : </label></td><td><label>01</label></td></tr>
		  <tr><td><label>Camera : </label></td><td><label>01</label></td></tr>
		  <tr><td><label>AC : </label></td><td><label>01</label></td></tr>
		  </table>
