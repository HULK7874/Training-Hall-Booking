...
<body style="background-color: silver;">
        ...
        <div id="navdiv1" class="container-fluid">
            ...
            <div id="navdiv" class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="HRnav-item-zim">
               <form action="HRrequestsBack.jsp" method="post">
                             <input type="text" id="HRnavinput" placeholder="Enter Booking ID" name="zim" required></input>
                    </li>
                    <li>
                        <select name="app" id="HRnavinputt" required>
	   	    	           <option style="background-color: green;">Approve</option>
	   	    	           <option style="background-color: red;">Reject</option>
	   	    	        </select>
                    </li>
                    <li><input type="submit" id="HRnavinputtt"></input></li>
               </form>
                </ul>
            </div>
        </div>
    ...
    <div class="slide">
        <table>
            ...
            <%
                ...
                {
            %>
            <form action="HRrequestUpdate.jsp" method="post">
            <tr>
                <td><%= record[0] %></td>
                <td><%= record[1] %></td>
                <td><%= record[2] %></td>
    ...
    <div class="pagination">
        ...
        <%
			...
			Class.forName("com.mysql.jdbc.Driver");
	   		Connection con1 = DriverManager.getConnection("jdbc:mysql://localhost:3306", "root", "12345");
	   		PreparedStatement ps1 = con1.prepareStatement ("Update advancejava.trainingBooking set status = ? where rid = ?");
	   		
	   		ps1.setString(1, Statu);
	   		ps1.setString(2, idd);
	    ...
	    %>
	          <br></br>
	    	  <center><lable id="HRlabupd">Status Updated Successfull</lable></center>
	    <%
	        }
	   		else
	   		{
