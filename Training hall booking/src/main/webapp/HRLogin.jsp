...
<html>
 <head>
  <title>Login to HR Portal for Training Hall Booking</title>
 ...
 <body id="Body">
                 ...
                 <div style="width: 81%; height: 130px;;float: right;">
                       <marquee scrollamount="8"><h1 style="font-family: cursive;">Welcome to HR Portal for Training Hall Booking</h1></marquee>
                 </div>
      <center>
                     <hr></hr>
                     <br></br>
                     <br></br>
                     <br></br> 
			<form action="HRLoginBack.jsp" method="post">
			      <table>
			              <td></td>
				          <tr>
						  <td>HR Id : </td>
